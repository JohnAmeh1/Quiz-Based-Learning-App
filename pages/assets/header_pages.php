...
<body>
    ...
    <nav id="content" class="hidden bg-white shadow-lg">
                    ...
                    <div class="hidden lg:flex items-center space-x-1">
                        ...
                        <div class="relative">
                            ...
                            <div id="pagesDropdownMenu" class="absolute hidden bg-white shadow-lg rounded-lg mt-2 w-48 z-10 border border-gray-300">
                                <a href="./about.php" class="block font-semibold px-4 py-2 text-gray-700 hover:bg-gray-100">About Us</a>
                                <a href="#" class="block font-semibold px-4 py-2 text-gray-700 hover:bg-gray-100">Our Team</a>
                                <a href="./contact.php" class="block font-semibold px-4 py-2 text-gray-700 hover:bg-gray-100">Contact Us</a>
        ...
        <div id="mobileMenu" class="mobile-menu hidden lg:hidden bg-gray-800 text-white">
            ...
            <a href="./about.php" class="block px-5 py-3 text-lg hover:bg-gray-700 transition-all duration-300">About Us</a>
            <a href="#" class="block px-5 py-3 text-lg hover:bg-gray-700 transition-all duration-300">Our Team</a>
            <a href="./contact.php" class="block px-5 py-3 text-lg hover:bg-gray-700 transition-all duration-300">Contact Us</a>
            <a href="#" class="block px-5 py-3 text-lg hover:bg-gray-700 transition-all duration-300">Company History</a>
            <a class="block py-3 px-5 text-lg hover:bg-gray-700 transition-all duration-300" href="./learner_mentor.php">
                Connect With Mentor
            </a>
