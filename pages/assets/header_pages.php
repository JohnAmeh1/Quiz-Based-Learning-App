...
<body>
    <nav class="bg-white shadow-lg">
            ...
            <div class="flex justify-between">
                <div class="flex space-x-4">
                    ...
                    <div class="hidden md:flex items-center space-x-1">
                        ...
                        <a class="py-5 px-3 text-gray-700 hover:text-gray-900" href="LearnerMentor.php">
                            Connect With Mentor
                        </a>
                    </div>
                </div>
        ...
        <div id="mobileMenu" class="mobile-menu hidden md:hidden">
            ...
            <a class="block py-2 px-4 text-sm hover:bg-gray-200" href="../about.php">
                About
            </a>
            <a class="block py-2 px-4 text-sm hover:bg-gray-200" href="../courses.php">
                Courses
            </a>
            <a class="block py-2 px-4 text-sm hover:bg-gray-200" href="../contact.php">
                Contact
            </a>
