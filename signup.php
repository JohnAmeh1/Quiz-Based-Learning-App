...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST["email"]) && isset($_POST["password"])) {
        ...
        if (strlen($username) > 8) {
            $em = "Username cannot be more than 8 characters";
        ...
        // if (strlen($password) > 8) {
        //     $em = "Password cannot be more than 8 characters";
        //     header("location: signup.php?error=" . urlencode($em));
        //     exit;
                ...
                <form enctype="multipart/form-data" method="post">
                    <div class="mb-4">
                        ...
                        <input type="file" id="image_path" name="image_path" accept="image/*"
                            ...
                            class=" px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-600 file:text-white hover:file:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                    </div>
                    <div class="mb-4">
