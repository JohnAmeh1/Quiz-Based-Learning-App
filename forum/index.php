                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <?php if (logged_in()): ?>
                        <button onclick="document.querySelector('.js-post-input').focus()"
                            class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-100">
                ...
                <?php if (logged_in()): ?>
                    <form onsubmit="mypost.submit(event)" method="post" class="bg-white p-6 rounded-lg shadow-sm">
                        ...
                        <textarea
                            ...
                            rows="4"></textarea>
                        <button class="mt-4 w-full inline-flex justify-center items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-100">
    ...
    <div class="js-post-card hide">
        <div class="post-card bg-white p-6 rounded-lg shadow-sm animate-fade-in">
            <div class="flex items-center justify-between mb-4">
                <a href="#" class="js-profile-link flex items-center space-x-3 pointer-events-none">
