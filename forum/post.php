                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <a href="profile.php?id=<?= $row['user']['user_id'] ?? 0 ?>"
                            class="flex items-center space-x-3 pointer-events-none">
                    ...
                    <span class="text-sm flex items-center justify-end text-gray-500">
                    ...
                    <form onsubmit="mycomment.submit(event)" method="post" class="mb-8">
                        <div class="flex space-x-4">
                            <textarea
                                ...
                                rows="3"></textarea>
                            <button class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-primary-100">
