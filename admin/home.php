...
<body class="bg-gray-100 min-h-screen">
    <div class="container mx-auto py-10 px-6">
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Total Users -->
            <div class="stat-card">
                <h2 class="font-bold"><i class="fa-regular fa-user me-2 text-xl text-blue-500"></i>Total Users</h2>
                <p class="text-blue-600" id="totalUsers">0</p>
            </div>

            <!-- New Signups -->
            <div class="stat-card">
                <h2 class="font-bold"><i class="fa-regular fa-user-circle me-2 text-xl text-purple-500"></i>New Signups</h2>
            ...
            <!-- Weekly Signups -->
            <div class="stat-card">
                <h2 class="font-bold"><i class="fa-regular fa-bookmark me-2 text-xl text-yellow-500"></i>Weekly Signups</h2>
