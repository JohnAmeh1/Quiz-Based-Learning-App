...
<body class="bg-gradient-to-r from-blue-50 to-blue-100 font-roboto">
  ...
  <script>
        ...
        success: function(response) {
          ...
          if (reviews.length === 0) {
            ...
            reviews.forEach((review) => {
              ...
              reviewsHtml += `
              <div class="hidden md:block bg-gray-100 p-5 rounded-lg cursor-pointer" onclick="openModal('${review.name}', '${review.created_at}', '${review.message}')">
    ...
    <p class="text-base">"${review.message}"</p>
      ...
      <div class="block md:hidden bg-gray-200 p-7 flex justify-between items-center bg-white p-[10px] rounded-lg w-64 cursor-pointer" onclick="openModal('${review.name}', '${review.created_at}', '${review.message}')">
...
<div id="reviewModal" class="hidden fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex flex-col items-center text-center justify-center z-50">
    ...
    function openModal(name, date, message) {
